...
const Product = (props) => {
  ...
  return <div className='col-4'>
     <div className="card mb-2 p-1">
        <img className="card-img-top"  style={{height: '121px', width: '121px', display: 'block', margin: 'auto',padding : '15px'}} src={productImage} data-holder-rendered="true"/>
        <div className="card-body p-1">
            <h6 className=" cut-text">{props.productName}</h6>
        </div>
        <div className="card-footer p-0">
            <a href="#" className="btn btn-sm w-100 btn-dark">Add To Cart</a>
        </div>
    </div>
  </div>;
};
